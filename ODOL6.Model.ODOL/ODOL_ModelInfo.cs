...
public class ODOL_ModelInfo
{
	...
	public void Read(BinaryReaderEx input, int nLods)
	{
		...
		byte variable2 = input.ReadByte();
		Logging_Functions.Echo(input, variable2, "geometryTopDown");
